...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        replaceMaterialEditableTexture, getSceneAnimFrameRate, getSceneByAction, getElement,
    };
};
...
registerOnClick('plano computador', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam 1', 'perspectiva', 1, function() {}, 0);
}, function(event) {});

registerOnHover('plano computador', false, function(event) {
    setHTMLElemStyle('cursor', 'pointer', click, false);
}, function(event) {
    setHTMLElemStyle('cursor', 'default', click, false);
});

click = 'ON';
video = loadVideo('https://raw.githack.com/bernalcontrerasjuanandres-jpg/fichui/main/comprimido.mp4');
registerOnClick('plano computador', false, false, [0,1,2], false, function(event) {
    if (click == 'ON') {
        replaceTexture('Material.009', 'inicion-windows.jpg.001', video, false, function() {});
...
operateAnimation('STOP', 'poker', null, null, 'AUTO', 1, function() {}, false);
registerOnClick('poker', false, false, [0,1,2], false, function(event) {
    operateAnimation('PLAY', 'poker', null, null, 'LoopOnce', 1, function() {}, false);
}, function(event) {});

operateAnimation('STOP', 'inteructor', null, null, 'AUTO', 1, function() {}, false);
operateAnimation('STOP', 'Light', null, null, 'AUTO', 1, function() {}, false);
registerOnClick('inteructor', false, false, [0,1,2], false, function(event) {
    operateAnimation('PLAY', 'inteructor', null, null, 'LoopOnce', 1, function() {}, false);
    operateAnimation('PLAY', 'Light', null, null, 'LoopOnce', 1, function() {}, false);
}, function(event) {});

registerOnClick('foto 1', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam foto computador', 'foto 1', 1, function() {}, 0);
}, function(event) {});

registerOnClick('foto 2 encima de escritorio', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam cuadro encima escritorio', 'foto 2 encima de escritorio', 1, function() {}, 0);
}, function(event) {});

registerOnClick('foto 23fondo extremo', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam foto cuadro extremo', 'foto 23fondo extremo', 1, function() {}, 0);
}, function(event) {});
...
eventHTMLElem('click', 'boton', false, function(event) {
    tweenCamera('cam 00', 'cuarto', 1, function() {}, 0);
});
